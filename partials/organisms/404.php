<section class="style-404" style="background-image: url(<?php echo get_stylesheet_directory_uri(); ?>/html_template/build/assets/img/about.png);">
    <div class="style-404__container">
        ...
        <img src="<?php echo get_stylesheet_directory_uri(); ?>/html_template/build/assets/img/404.png" alt="img" />
        <div class="mt-4 w-100 d-flex justify-content-center">
            <a href="<?php echo get_home_url(); ?>" class="blue-btn"><?php _e('Головна','custom'); ?></a>
        </div>
    </div>
</section>